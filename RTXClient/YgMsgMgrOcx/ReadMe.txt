========================================================================
		ActiveX Control DLL : YGMSGMGROCX
========================================================================

ControlWizard has created this project for your YGMSGMGROCX ActiveX Control
...
that make up your YGMSGMGROCX ActiveX Control DLL.
...
YgMsgMgrOcxCtl.h
	This file contains the declaration of the CYgMsgMgrOcxCtrl C++ class.

YgMsgMgrOcxCtl.cpp
	This file contains the implementation of the CYgMsgMgrOcxCtrl C++ class.

YgMsgMgrOcxPpg.h
	This file contains the declaration of the CYgMsgMgrOcxPropPage C++ class.

YgMsgMgrOcxPpg.cpp
	This file contains the implementation of the CYgMsgMgrOcxPropPage C++ class.

YgMsgMgrOcxCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CYgMsgMgrOcxCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file YgMsgMgrOcx.rc.
