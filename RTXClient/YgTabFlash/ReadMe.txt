========================================================================
		ActiveX Control DLL : YGTABFLASH
========================================================================

ControlWizard has created this project for your YGTABFLASH ActiveX Control
...
that make up your YGTABFLASH ActiveX Control DLL.
...
YgTabFlashCtl.h
	This file contains the declaration of the CYgTabFlashCtrl C++ class.

YgTabFlashCtl.cpp
	This file contains the implementation of the CYgTabFlashCtrl C++ class.

YgTabFlashPpg.h
	This file contains the declaration of the CYgTabFlashPropPage C++ class.

YgTabFlashPpg.cpp
	This file contains the implementation of the CYgTabFlashPropPage C++ class.

YgTabFlashCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CYgTabFlashCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file YgTabFlash.rc.
